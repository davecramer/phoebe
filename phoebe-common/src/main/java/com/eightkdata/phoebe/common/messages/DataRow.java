...
@Immutable
public class DataRow extends AbstractByteBufMessage {

  int numColumns;

  public DataRow(@Nonnull ByteBuf byteBuf) {
    super(byteBuf);
  }
  ...
  public void fillInPayloadInformation(MoreObjects.ToStringHelper toStringHelper) {
    numColumns = byteBuf.getShort(byteBuf.readerIndex());
    toStringHelper.add("columns", numColumns);
  }
